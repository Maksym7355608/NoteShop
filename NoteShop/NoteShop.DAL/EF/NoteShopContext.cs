...
namespace NoteShop.DAL.EF
{
    public class NoteShopContext : DbContext
    {
        ...
        public DbSet<Cart> Likes { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                 new Notebook() { Id = 1, Name = "Notebook Poligraphist 12", Price = 1, Count = 100, ImageId = 1, Murkup = Murkup.Oblique, PageCount = 12, Size = Format.A5 },
                 new Notebook() { Id = 2, Name = "Notebook Poligraphist 18", Price = 1.25f, Count = 190, ImageId = 2, Murkup = Murkup.Square, PageCount = 18, Size = Format.A5},
                 new Notebook() { Id = 3, Name = "Notebook Poligraphist 12", Price = 1.2f, Count = 310, ImageId = 3, Murkup = Murkup.Inline, PageCount = 12, Size = Format.A5},
                 new Notebook() { Id = 4, Name = "Notebook 1st September 48", Price = 15, Count = 70, ImageId = 4, Murkup = Murkup.Oblique, PageCount = 48, Size = Format.A4},
                 new Notebook() { Id = 5, Name = "Notebook 1st September 18", Price = 2.25f, Count = 80, ImageId = 5, Murkup = Murkup.Oblique, PageCount = 18, Size = Format.A5},
                 new Notebook() { Id = 6, Name = "Notebook 1st September 12", Price = 1.2f, Count = 150, ImageId = 6, Murkup = Murkup.Oblique, PageCount = 12, Size = Format.A6},
                 new Notebook() { Id = 7, Name = "Notebook Poligraphist 24", Price = 3.5f, Count = 220, ImageId = 7, Murkup = Murkup.Oblique, PageCount = 24, Size = Format.A4}
            });

            modelBuilder.Entity<Diary>().HasData(new Diary[]
            {
                new Diary() { Id = 8, Name = "Diary Ranok", Price = 35, Count = 50, ImageId = 8, StyleCover = Cover.Soft },
                new Diary() { Id = 9, Name = "Diary Rozumniy", Price = 50, Count = 27, ImageId = 9, StyleCover = Cover.Hard },
                new Diary() { Id = 10, Name = "Diary Elite", Price = 70, Count = 10, ImageId = 10, StyleCover = Cover.Leather }
            });

            modelBuilder.Entity<Pen>().HasData(new Pen[]
            {
                new Pen() { Id = 11, Name = "Pen Pilot", Price = 1, Count = 100, ImageId = 11, Color = Color.Blue, Thickness = 0.85f },
                new Pen() { Id = 12, Name = "Pen MaxWriter", Price = 4, Count = 70, ImageId = 12, Color = Color.Black, Thickness = 0.5f },
                new Pen() { Id = 13, Name = "Pen BIG", Price = 5, Count = 40, ImageId = 13, Color = Color.Green, Thickness = 0.75f },
                new Pen() { Id = 14, Name = "Pen cells 10km", Price = 15, Count = 70, ImageId = 14, Color = Color.Red, Thickness = 0.65f },
            });

            modelBuilder.Entity<Pencil>().HasData(new Pencil[]
            {
                new Pencil() { Id = 15, Name = "Pencil LowMarco", Price = 2, Count = 170, ImageId = 15, Hardness = Hardness.F },
                new Pencil() { Id = 16, Name = "Pencil Marco", Price = 4, Count = 200, ImageId = 16, Hardness = Hardness.HB }
            });
        }
    }
}
